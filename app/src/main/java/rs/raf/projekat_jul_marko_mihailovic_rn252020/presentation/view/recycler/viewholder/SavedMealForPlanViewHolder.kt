...
class SavedMealForPlanViewHolder (
    private val itemBinding: LayoutSavedMealItemForPlanBinding,
    ...
    fun bind(meal: SavedMeal) {
        ...
        itemBinding.button2.setOnClickListener {
            if(viewModel.selectedFromDatabaseIndex.value != null) bindingAdapter!!.notifyItemChanged(viewModel.selectedFromDatabaseIndex.value as Int)
            viewModel.selectedFromDatabaseIndex.value = bindingAdapterPosition
            viewModel.selectedFromDatabase.value = meal
