...
import rs.raf.projekat_jul_marko_mihailovic_rn252020.presentation.view.adapters.MealsForCategoryAdapter

class MealsForCategoryFragment(
    private val category: String
) : Fragment(R.layout.fragment_meals_for_category) {
